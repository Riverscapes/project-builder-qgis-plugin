...
from project_builder_dialog import ProjectBuilderDialog
import os.path
...
class ProjectBuilder:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ProjectBuilder_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Riverscapes Project Builder')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ProjectBuilder/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Riverscapes Project Builder'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Riverscapes Project Builder'),
                action)
